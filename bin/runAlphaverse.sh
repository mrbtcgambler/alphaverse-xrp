...
sudo umount /mnt/alphaverse-xrp
echo "Creating /mnt/ramdrive if it doesn't exist..."
sudo mkdir -p /mnt/alphaverse-xrp
echo "Mounting /mnt/ramdrive..."
sudo mount -t tmpfs -o size=900M,mode=777 tmpfs /mnt/alphaverse-xrp/
sudo rsync -avz --exclude="alphaverse-1.0.4.AppImage" ~/alphaverse-xrp/ /mnt/alphaverse-xrp/
sudo chown ${USER} /mnt/alphaverse-xrp/*
cd /mnt/alphaverse-xrp/bin/
chmod +x *.sh
cd ..
