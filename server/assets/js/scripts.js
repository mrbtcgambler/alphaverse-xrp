...
const app = Vue.createApp({
    ...
    mounted() {
        ...
        this.fetchXrpUsdValue(); // Corrected function name for clarity
        window.setInterval(() => { this.fetchXrpUsdValue() }, 60000); // Corrected function name for clarity
    },
    ...
    methods: {
        ...
        async fetchXrpUsdValue() { // Renamed for clarity
            // --- CRITICAL FIX: Changed 'tron' to 'ripple' ---
            let currency = 'ripple'; 
            ...
            try {
                ...
                console.log('Fetched XRP conversion rate:', this.currencyConversionRate);
            } catch (error) {
